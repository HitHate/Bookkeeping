...
import com.example.bookkeeping.databinding.FragmentGetBinding;
...
public class GetFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        factory = new GetViewModelFactory(repository);
        adapter = new Adapter();

        mViewModel = new ViewModelProvider(requireActivity(),factory).get(GetViewModel.class);

        recyclerView = binding.showGet;
