...
import com.example.bookkeeping.databinding.FragmentTotalPayGetBinding;
...
public class TotalPayGetFragment extends Fragment {

    private TotalPayGetViewModel mViewModel;
    private FragmentTotalPayGetBinding binding;
    private RecordRepositoryImpl repository;
    private TotalPayGetViewModelFactory factory;
    ...
    public static TotalPayGetFragment newInstance() {
        return new TotalPayGetFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        binding = FragmentTotalPayGetBinding.inflate(inflater,container,false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        factory = new TotalPayGetViewModelFactory(repository);
        adapter = new Adapter();

        mViewModel = new ViewModelProvider(requireActivity(),factory).get(TotalPayGetViewModel.class);

        recyclerView = binding.showPayGet;
